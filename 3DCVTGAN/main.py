...
import networks.CVT3D_Model_SSF as CVT3D_Model_SSF
import warnings
...
parser.add_argument("--rf", default=8, type=int, help="reduction factor of adapter block")
parser.add_argument("--r", default=8, type=int, help="rank of lora")
parser.add_argument("--lora_alpha", default=16, type=int, help="alpha of lora")
parser.add_argument("--deep", action="store_true", help="allow VPT Deep mode")
parser.add_argument("--tune_mode", default="", type=str)
...
def main_worker(gpu, args):  
    ...
    if args.tuning:
        ...
        if args.tune_mode in ["shallow", "deep", "shallow_bias"]:
