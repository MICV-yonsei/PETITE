...
parser.add_argument("--fft_path", default="", type=str, help="VPT-shallow results folder path")
parser.add_argument("--ln_path", default="", type=str, help="VPT-shallow results folder path")
parser.add_argument("--bias_path", default="", type=str, help="VPT-deep results folder path")
parser.add_argument("--lora_path", default="", type=str, help="VPT-shallow results folder path")
parser.add_argument("--adapter_path", default="", type=str, help="VPT-deep results folder path")
parser.add_argument("--ssf_path", default="", type=str, help="VPT-shallow results folder path")
parser.add_argument("--shallow_path", default="", type=str, help="VPT-deep results folder path")
