...
from networks.unetr import UNETR, Prompted_UNETR, Adapted_UNETR, PETITE_UNETR, Lora_UNETR, SSF_UNETR
...
parser.add_argument("--logdir_ep", default="", type=str, help="directory to save the tensorboard logs")
...
parser.add_argument("--sw_batch_size", default="", type=int, help="number of sliding window batch size")
...
# PEFT
parser.add_argument("--tune_mode", default="", type=str, help="Tuning mode")
...
parser.add_argument("--lora_alpha", default=16, type=int, help="Alpha value of LoRA")
# Wandb
...
def main_worker(gpu, args):
    ...
    elif args.tune_mode in ["fft", "bn", "ln", "bias", "org", "vit", "vit_top", "vit_down", "vit_skip", "novit", "only_de2_tuning", None]:
        model = UNETR(
                    in_channels=args.in_channels,
                    out_channels=args.out_channels,
                    img_size=(args.roi_x, args.roi_y, args.roi_z),
